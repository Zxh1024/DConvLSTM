...
class DeformableConvLSTM_SAC_Cell(nn.Module):

    def __init__(self, in_channel, num_hidden, width, filter_size, stride, layer_norm):
        super(DeformableConvLSTM_SAC_Cell, self).__init__()
        ...
        self.conv = nn.Sequential(
            DeformConv2d(2, 3, kernel_size=filter_size, stride=stride, padding=self.padding),
